...
import { DefaultMessageNotificationLevels, ExplicitContentFilterLevels, GuildFeatures, SystemChannelFlags, VerificationLevels } from "../../types/shared.js";
/** Modify a guilds settings. Requires the MANAGE_GUILD permission. */
export declare function editGuild(bot: Bot, guildId: bigint, options: ModifyGuild, shardId: number): Promise<import("../../mod.js").Guild>;
